...
2.用postman请求时，在Headers中添加 application/prs.xxx.v1+json，xxx替换为.env文件定义的API_SUBTYPE
...
### 注意
1.Laravel框架的不同版本，对其它扩展包安装的要求版本可能不一样，请根据实际情况进行版本的调整

2.更多，更详细的接口以及参数说明和限制，请查看代码

3.该扩展包仅供大家参考使用，根据各自项目的不同情况，进行修改

4.该扩展包为基本版本，往后有时间再进行升级完善

5.如果有写的不够好，或者有错误的地方，欢迎且希望各位大神能多给指点
